                ...
                >
                    <SwiperSlide key={1}>
                        <p className={styles.homeText} aria-label="Compétences">
                            ...
                            <br/>
                            Amateur de <strong>photographie</strong> et de <strong>cinéma</strong> j'utilise
                            aussi <strong>Affinity
                    ...
                    <SwiperSlide key={2}>
                        <p className={styles.homeText} aria-label="Parcours profesionnel">
                            ...
                            d'adultes</strong> en situation de <strong>handicap</strong> par
                            le <strong>cinéma</strong> et
                    ...
                    <SwiperSlide key={3}>
                        <p className={styles.homeText} aria-label="Parcours professionel deuxième partie">
                            ...
                            j'ai <strong>quitté</strong> ma <strong>carrière</strong> pour
                            me <strong>reconvertir </strong>
                            ...
                            Intégrateur Web</strong> (RNCP-5, Bac+2) auprès d'<strong>OpenClassrooms</strong>.
                            <br/>
                            En recherche d'<strong>Alternance</strong> pour un nouveau titre RNCP-5,
                            orienté <strong>full-stack</strong> avec <strong>2I Academy</strong>.
                        </p>
                    </SwiperSlide>
                </Swiper>
            </div>
